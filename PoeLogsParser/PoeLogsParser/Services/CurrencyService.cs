...
namespace PoeLogsParser.Services
{
    public class CurrencyService : IService
    {
        ...
        private readonly Dictionary<string, string> _currencyToImageLink = new Dictionary<string, string>()
        {
            {
                "alt",
        ...
        {
            return _currencyToImageLink.ContainsKey(currencyName)
                ? _currencyToImageLink[NormalizeCurrency(currencyName)]
                : "";
        }
