...
exports.normalizeCurrency = exports.getRealName = exports.getCurrencyImageLink = void 0;
const currencyToImageLink = {
...
function getCurrencyImageLink(currencyName) {
    return currencyToImageLink[currencyName] ? currencyToImageLink[normalizeCurrency(currencyName)] : "";
}
exports.getCurrencyImageLink = getCurrencyImageLink;
function getRealName(text) {
    const result = {
        "chaos": "Chaos Orb",
